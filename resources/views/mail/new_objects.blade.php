                        ...
                        <div
                          ...
                          <p
                            ...
                            <span style="font-size: 18px;"><strong><span
                                  style="font-size: 18px;">Добрый день!</span></strong></span></p>
                          <p
                          ...
                          <p
                            style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 18px; margin: 0;">
                            <span style="font-size: 15px;">В каталоге объектов ИНВЕСТТЕХ.PRO
                              появились новые объекты.</span><br /><span style="font-size: 15px;">Вы
                              можете ознакомиться с информацией во вложенных файлах </span><span
                              style="font-size: 15px;">или по ссылкам:</span></p>
                          <p
                            style="font-size: 12px; line-height: 1.2; mso-line-height-alt: 14px; margin: 0;">
                             </p>
                          <ul>
                            @foreach ($links as $link)
                              <li style="font-size: 12px; line-height: 14px;"><span
                                style="font-size: 15px;"><a href="{{ $link }}"
                                    rel="noopener" style="text-decoration: underline; color: #0068A5;"
                                    target="_blank"><span
                                      style="font-size: 15px;">{{ $link }}</span></a></span>
                              </li>
                            @endforeach
                          </ul>
                          <p
                          ...
                          <p
                            style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 18px; margin: 0;">
                            <span style="font-size: 15px;">Благодарим за внимание!</span></p>
                          <p
                            style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 18px; margin: 0;">
                            <span style="font-size: 15px;">С уважением, </span><br /><span
                              style="font-size: 15px;">команда ГК «Инвестиционные
                              технологии»</span><span style="font-size: 15px;"></span></p>
                        </div>
                      </div>
