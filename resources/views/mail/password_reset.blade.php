                  ...
                  <div style="width:100% !important;">
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div
                          style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.2; color: #555555; mso-line-height-alt: 14px;">
                          <p
                            style="font-size: 18px; line-height: 1.2; mso-line-height-alt: 22px; margin: 0;">
                            <span style="font-size: 18px;"><strong><span
                                  style="font-size: 18px;">Здравствуйте!</span></strong></span></p>
                          <p
                          ...
                          <p
                            ...
                             </p>
                          <p
                            style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 18px; margin: 0;">
                            <span style="font-size: 15px;">Вы отправили запрос на сброс пароля на
                              нашем сайте <a href="https://investtex.pro" rel="noopener"
                                style="text-decoration: underline; color: #0068A5;"
                                target="_blank">https://investtex.pro</a>.</span></p>
                          <p
                            style="font-size: 12px; line-height: 1.2; mso-line-height-alt: 14px; margin: 0;">
                             </p>
                        </div>
                      ...
                      <div align="center" class="button-container"
                        ...
                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 25px; padding-right: 10px; padding-bottom: 25px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://yandex.ru" style="height:31.5pt; width:130.5pt; v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
                          href="https://investtex.pro/lk/password/reset/{{ $token }}?email={{ $email }}"
                          ...
                          target="_blank"><span
                            ...
                            <span
                              style="font-size: 16px; line-height: 2; mso-line-height-alt: 32px;">Сбросить
                              пароль</span>
                          </span></a>
                      ...
                      <div
                        style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                        <p
                          style="font-size: 15px; line-height: 1.2; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 18px; margin: 0;">
                          <span style="font-size: 15px;">Данная ссылка на сброс пароля будет
                            действительна в течение 60 минут.</span></p>
                        <p
                          style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 14px; margin: 0;">
                           </p>
                        <p
                          style="font-size: 15px; line-height: 1.2; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 18px; margin: 0;">
                          <span style="font-size: 15px;">Если Вы не отправляли такой запрос, просто
                            игнорируйте это письмо</span></p>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      <!--[if (!mso)&(!IE)]><!-->
                    </div>
                      ...
                      <div
                        ...
                        <div
                          ...
                          <p
                            ...
                            <span style="font-size: 13px; mso-ansi-font-size: 14px;">Если кнопка не
                              нажимается, скопируйте и вставьте данную ссылку в адресную строку
                              браузера: <a href="https://investtex.pro/lk/password/reset/{{ $token }}?email={{ $email }}" rel="noopener"
                                style="text-decoration: underline; color: #0068A5;"
                                target="_blank">https://investtex.pro/lk/password/reset/{{ $token }}?email={{ $email }}</a></span></p>
                        </div>
                      </div>
                      <!--[if mso]></td></tr></table><![endif]-->
                      <!--[if (!mso)&(!IE)]><!-->
